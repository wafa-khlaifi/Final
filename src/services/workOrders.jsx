 ...
 * @param {string} workorderid - L'identifiant du workorder (en minuscules).
 */
export const fetchPredictionByWorkorderId = async (workorderid) => {
  try {
    ...
    console.error('[Prediction] Erreur :', error.message);
    return {
      success: false,
      error: error.message,
    };
